 ...
 * **db-schema-spec** : [`1.2`](https://github.com/katmore/database-schema-versioning/releases/tag/v1.2.0) - Major release v1.2
 ...
 * **db-schema-spec** : The [Database Schema Versioning](#Major-Release-History) specification release being used in this [JSON object](https://tools.ietf.org/html/rfc7159#section-4).
